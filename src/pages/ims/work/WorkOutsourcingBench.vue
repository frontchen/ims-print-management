...
export default {
  ...
  methods: {
    ...
    scrollStaffName() {
      if (!this.staffName.hasMore) {
        return false
      }
      this.staffName.pageIndex += 1
      this.getStaffNameList(this.staffName.pageIndex, {
        staffName: this.staffName.query
      })
    },
    queryStaffName(query) {
      this.staffName.query = query
    ...
    async getStaffNameList(page = 1, param = {}) {
      ...
      vm.modal1.staffName.hasMore = hasMore
    },
    // 根据工单工艺id获取工艺报工明细
